  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600">
      <div className="text-center text-white p-8">
        <h1 className="text-6xl font-bold mb-4">invoiceremindertest</h1>
        <p className="text-xl mb-8">track invoices and send email reminders</p>
        <p className="text-3xl font-semibold">$0/month</p>
